...
//    }
    ...
    public void getAllUsersTest() throws Exception {
        ...
        UserDto object1 = UserDto.builder().name("abhinav").email("abhi@gmail.com").password("abhinav").about("Testing").build();
        UserDto object2 = UserDto.builder().name("Amit").email("abhi@gmail.com").password("abhi").about("Testing").build();
        UserDto object3 = UserDto.builder().name("Sumit").email("abhi@gmail.com").password("sumit").about("Testing").build();
        UserDto object4 = UserDto.builder().name("Ankit").email("abhi@gmail.com").password("ankit").about("Testing").build();
